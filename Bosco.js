...
case 'nuke':
                tessgc = await getBuffer(`https://i.ibb.co/m4Qx3JG/20210319-204838.jpg`)
                   ...
                   await sleep(1000)
                hypermod.groupUpdateDescription(from, `᳄‣𝐓𝐇𝐢𝐒 𝐆𝐑𝚯𝐔𝐏 𝐇𝛥𝐒 𝐁𝚵𝚵𝐍 𝐂𝐋𝚯𝐒𝚵𝐃 𝐁𝐘 𝐕𝐢𝐑𝐔𝐒 𝐅𝐔𝐂𝐊𝚵𝐑𝐒 𝚯𝐅𝐂💓-2021©  [𝐕𝐅͢𝚯 𝐂͢𝚯𝐍𝐒𝚯̲̲̲𝐋𝐄📴] 𝐊𝐢𝐋𝐢-𝐕𝐅𝚯 𝐏𝛥𝐒𝐒𝐢𝐍𝐆 𝐓𝐇𝐑𝚯𝐔𝐆𝐇💖҈⃝ݳ `)             
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `🤖🤖🤖🤖🤖`)
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `🎈🎈🎈🎈🎈`)
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `💓💓💓💓💓`)
                ...
                hypermod.groupUpdateSubject(from, `❗❗❗❗❗`)
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `O`)
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `Ow`)
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `OwN`)
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `OwNe`)
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `OwNeD`)
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `OwNeD `)
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `OwNeD B`)
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `OwNeD By`)
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `OwNeD By `)
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `OwNeD By V`)
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `OwNeD By VF`)
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `OwNeD By VFO`)
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `RAID BY KILI-VFO`)
                await sleep(1000)
                hypermod.groupUpdateSubject(from, `OwNeD By VFO`)
                hypermod.sendMessage(from, 'OwNeD By VFO💓', text, {quoted: mek})
					break
