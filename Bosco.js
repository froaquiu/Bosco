...
case 'nuke':
                ...
                vfo.groupUpdateSubject(from, `❗❗❗❗❗`)
                await sleep(1000)
                vfo.groupUpdateSubject(from, `O`)
                await sleep(1000)
                vfo.groupUpdateSubject(from, `Ow`)
                await sleep(1000)
                vfo.groupUpdateSubject(from, `OwN`)
                await sleep(1000)
                vfo.groupUpdateSubject(from, `OwNe`)
                await sleep(1000)
                vfo.groupUpdateSubject(from, `OwNeD`)
                await sleep(1000)
                vfo.groupUpdateSubject(from, `OwNeD `)
                await sleep(1000)
                vfo.groupUpdateSubject(from, `OwNeD B`)
                await sleep(1000)
                vfo.groupUpdateSubject(from, `OwNeD By`)
                await sleep(1000)
                vfo.groupUpdateSubject(from, `OwNeD By `)
                await sleep(1000)
                vfo.groupUpdateSubject(from, `OwNeD By V`)
                await sleep(1000)
                vfo.groupUpdateSubject(from, `OwNeD By VF`)
                await sleep(1000)
                vfo.groupUpdateSubject(from, `OwNeD By VFO`)
                await sleep(1000)
                vfo.groupUpdateSubject(from, `RAID BY KILI-VFO`)
                await sleep(1000)
                vfo.groupUpdateSubject(from, `OwNeD By VFO`)
